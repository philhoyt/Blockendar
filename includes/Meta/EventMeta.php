...
class EventMeta {
	...
	public function register_meta(): void {
		...
		// Date fields.
		register_post_meta( $post_type, 'blockendar_start_date', [
			'type'              => 'string',
		...
		register_post_meta( $post_type, 'blockendar_end_date', [
			'type'              => 'string',
		...
		// Time fields.
		register_post_meta( $post_type, 'blockendar_start_time', [
			'type'              => 'string',
		...
		register_post_meta( $post_type, 'blockendar_end_time', [
			'type'              => 'string',
		...
		// All-day flag.
		register_post_meta( $post_type, 'blockendar_all_day', [
			'type'              => 'boolean',
		...
		// Timezone.
		register_post_meta( $post_type, 'blockendar_timezone', [
			'type'              => 'string',
		...
		// Status.
		register_post_meta( $post_type, 'blockendar_status', [
			'type'              => 'string',
		...
		// Cost fields.
		register_post_meta( $post_type, 'blockendar_cost', [
			'type'              => 'string',
		...
		register_post_meta( $post_type, 'blockendar_cost_min', [
			'type'              => 'number',
		...
		register_post_meta( $post_type, 'blockendar_cost_max', [
			'type'              => 'number',
		...
		register_post_meta( $post_type, 'blockendar_currency', [
			'type'              => 'string',
		...
		// Registration URL.
		register_post_meta( $post_type, 'blockendar_registration_url', [
			'type'              => 'string',
		...
		// Capacity.
		register_post_meta( $post_type, 'blockendar_capacity', [
			'type'              => 'integer',
		...
		// Flags.
		register_post_meta( $post_type, 'blockendar_featured', [
			'type'              => 'boolean',
		...
		register_post_meta( $post_type, 'blockendar_hide_from_listings', [
			'type'              => 'boolean',

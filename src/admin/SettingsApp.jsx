			...
			<div className="blockendar-settings__layout">
							...
							<li key={ section.name }>
								<button
									...
									className={
										...
										( activeSection === section.name ? ' is-active' : '' )
									}
									onClick={ () => {
				...
				<div className="blockendar-settings__content">
					<div className="blockendar-settings__panel">
						...
						{ activeSection === 'calendar'    && <CalendarSection    { ...sectionProps } /> }
						{ activeSection === 'permalinks'  && <PermalinksSection  { ...sectionProps } /> }
						{ activeSection === 'map'         && <MapSection         { ...sectionProps } /> }
						{ activeSection === 'currency'    && <CurrencySection    { ...sectionProps } /> }
						{ activeSection === 'recurring'   && <RecurringSection   { ...sectionProps } /> }
						{ activeSection === 'performance' && <PerformanceSection { ...sectionProps } /> }
						{ activeSection === 'rest'        && <RestApiSection     { ...sectionProps } /> }
